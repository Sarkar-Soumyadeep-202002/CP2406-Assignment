...
public class RainfallData {
     ...
     * It is used to iterate through the data of a RainfallData object.
     */
    ...
    public String getDateRange() {
        ...
        // Check if the selected year and month are within the correct range.
    ...
    public double getMaxTotalRainfall() {
        ...
        for (MonthRainfallData monthRainfallData : totalRainfallData) {
            if (monthRainfallData.getTotal() > maxTotalRainfall) // Check if the total monthly rainfall is the highest total or not.
    ...
    public void setFilename(String path) {
        ...
        String[] filenameElements = file.getName().trim().split("\\."); // Store all the parts of the file path in an array.
