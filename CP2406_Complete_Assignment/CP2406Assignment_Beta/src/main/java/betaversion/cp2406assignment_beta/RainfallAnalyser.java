 ...
 * This is the beta version of the Rainfall Analyser class.
 * It makes use of the RainfallDataSet class and the CSV package from Apache.
 */
public class RainfallAnalyser {
    ...
    public RainfallData analyseRainfallData(String path) throws Exception {
        ...
        Iterable<CSVRecord> records = CSVFormat.DEFAULT.withHeader().parse(reader); // Read the csv file with the selected path.
        ...
        for (CSVRecord record : records) {
            ...
            if (month != currentMonth) {
                ...
                monthlyTotal = 0;
                maxRainfall = 0.0;
                minRainfall = Double.POSITIVE_INFINITY; // Assign a default value to the minRainfall variable.
            }

            // Update the total for the month.
            monthlyTotal += rainfall; // Calculate the monthly total rainfall.
    ...
    public RainfallData getAnalysedRainfallData(String path) throws IOException {
        ...
        rainfallData.setFilename(path); // Set the name of the selected file.
        Reader reader = new FileReader(path);
        Iterable<CSVRecord> records = CSVFormat.DEFAULT.withHeader().parse(reader); // Read the csv file with the selected path.
    ...
    public String saveRainfallData(RainfallData rainfallData) {
        ...
        TextIO.writeFile(savePath); // Write in the file with the selected path.
        ...
        for (MonthRainfallData monthRainfallData : rainfallData.getRainfallData()) {
            TextIO.putf("%d,%d,%1.2f,%1.2f,%1.2f\n",
                    ...
                    monthRainfallData.getMin(), monthRainfallData.getMax()); // Format the data before writing it into the file.
        }
